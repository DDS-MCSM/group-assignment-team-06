...
```{r, include=FALSE}
# TODO
# head(10) de la tabla con la que te quedas sólo 5 columnas
```
...
barplot(top10_countries_attacks_plot$attacks, names = top10_countries_attacks_plot$country, horiz=TRUE,
  xlab = "Número de ataques", ylab = "Países",
  main = "Top 10 de países que más ataques realizan", cex.lab=1.5, cex.main=1.5)
```
...
```{r, include=FALSE}
# TODO
# Modificar los títulos y las leyendas
```
...
barplot(top10_countries_norm_plot$attacks_population, names = top10_countries_norm_plot$country, horiz=TRUE,
  ...
  main = "Top 10", cex.lab=1.5, cex.main=1.5)
```
...
A continuación, mostramos el mapa de calor en base a este Top 10 normalizado de atacantes.
...
```{r, include=FALSE}
# TODO
# Tabla completa con los países y su número total de habitantes, ordenado por número de habitantes
```
...
```{r, include=FALSE}
# TODO
# Tabla completa con los países y su número total de habitantes, ordenado por el resultado ataques/habitantes
```
